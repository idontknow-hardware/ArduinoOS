...
int Keyboard() {
  ...
  if(keyboard == 1) {
    Cursor(0, 0);
    if (klawisz != 0) {
    lcd.print(keys[klawisz - 13 + 9 * s_keyboard]);
 ...
 Clear();  }}}if (strona == 1){
  ...
  if (roznicaCzasu > 10000) {
    ...
    if (aplikacje[0] == 0) {
      ...
      printAPPS();
      Cursor(0, 0);
      print(F("3. Wszystkie aplikacje"), F("3. All apps"));
      int klawisz = input();
      if (klawisz == 13) {
  ...
  rtc.setDateTime(&dt);
        ...
        if (klawisz == 7) {
          ...
          if (klawisz == 13) {
            ...
            if (liczba == 3) {
              ...
              kod = 0;
              Serial.println(EEPROM.read(plik + i_wg));
              Serial.print("okej");
              Serial.print(i_wg);
              liczba = 0;
              i_wg++;
      ...
      if (int(t) != 0) {
        ...
        if (EEPROM.read(plik + i_kodu) == 1) {
          ...
          lcd.print(F("function not useful yet"));
